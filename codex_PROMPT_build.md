...
2. Read `AGENTS.md` to understand codebase patterns and commands
...
- Always use the `python-senior-practices` skill
- Follow existing code patterns
- Keep changes minimal and focused
- Use subagents (also using the `developing-python` skill) for parallel work when appropriate
- WRITE TEST FIRST (Classical TDD) using the `write-tests-tdd` skill
